...
vc_map( array(
  ...
  [vc_accordion_tab title="'.__('Section 3', "js_composer").'"][/vc_accordion_tab]
  ',
...
vc_map( array(
    "name" => __("Posts Grid 2", "js_composer"),
    "base" => "vc_posts_grid",
    "is_container" => true,
    "icon" => "icon-wpb-application-icon-large",
    "params" => array(
        ...
        array(
            ...
            "options" => array(
                ...
                array('text', __('Text', "js_composer")),
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            "param_name" => "autoplay",
            "value" => "5000",
            "description" => __("Delay between transitions (in ms). If this parameter is not specified, auto play will be disabled", "js_composer")
        ),
        array(
            "type" => "textfield",
        ...
        array(
            "type" => "options",
            "heading" => __("Extendend options", "js_composer"),
            "param_name" => "swiper_options",
            "description" => __("Here comes a list of options provided by Swiper API", "js_composer"),
            "options" => array(
                array(
                    "type" => "separator",
                    "label" => "General"
                ...
                array(
                    "type" => "input",
                    "label" => __("Loop additional slides", "js_composer"),
                    "name" => "loop_additional_slides",
                    "description" => __("Addition number of slides that will be cloned after creating of loop", "js_composer"),
                    "value" => "0",
                    "value_type" => 'integer'
                ),
                array(
                    "type" => "input",
                    "label" => __("Slider per group", "js_composer"),
